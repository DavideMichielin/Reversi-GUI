        ...
        public TestGridBagLayout() {
            EventQueue.invokeLater(new Runnable() {
                ...
                public void run() {
                    ...
                    p1.setMinimumSize(new Dimension(700, 700));
                    p1.setMaximumSize(new Dimension(700, 700));
                    ...
                    p2.setMinimumSize(new Dimension(300, 700));
                    p2.setMaximumSize(new Dimension(300, 700));
